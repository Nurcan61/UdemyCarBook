    ...
    public partial class mig_first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarDescritions", x => x.CarDescriptionId);
                    table.ForeignKey(
                        name: "FK_CarDescritions_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarPrincings", x => x.CarPricingId);
                    table.ForeignKey(
                        name: "FK_CarPrincings_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarPrincings_Pricings_PricingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "CarId");
                    table.ForeignKey(
                        name: "FK_Features_Features_FeatureId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarDescritions_CarId",
                table: "CarDescritions",
                column: "CarId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarPrincings_CarId",
                table: "CarPrincings",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarPrincings_PricingId",
                table: "CarPrincings",
                column: "PricingId");
